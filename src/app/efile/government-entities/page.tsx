...
export default function GovernmentEntities() {
    ...
    <div className="h-screen w-screen bg-white flex overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-2xl mx-auto p-8">
          <h1 className="text-4xl font-light text-gray-900 mb-6">3. Government and Related Government Entities</h1>
          <p className="text-gray-600 mb-8">
            Government and related entity compliance requirements and documentation.
          </p>
          
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-left">
            <h3 className="font-medium text-gray-900 mb-4">✅ Section Complete</h3>
            <p className="text-gray-600">
              All government and related entity requirements have been successfully completed and verified.
            </p>
          </div>
