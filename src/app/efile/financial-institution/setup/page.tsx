    ...
    <div className="h-screen w-screen bg-white flex overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-2xl mx-auto p-8">
          <h1 className="text-4xl font-light text-gray-900 mb-6">1.1 Setup</h1>
          <p className="text-gray-600 mb-8">
            Configure your financial institution details and basic setup.
          </p>
          
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-left">
            <h3 className="font-medium text-gray-900 mb-4">Setup Requirements:</h3>
            <ul className="space-y-2 text-gray-600">
              <li>• Institution name and type</li>
              <li>• Regulatory identification numbers</li>
          ...
          <div className="mt-8">
            ...
            <p className="text-sm text-gray-500">Currently Active Step</p>
          </div>
        </div>
      </div>
    </div>
