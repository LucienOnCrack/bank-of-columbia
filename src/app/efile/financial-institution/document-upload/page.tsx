    ...
    <div className="h-screen w-screen bg-white flex overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-2xl mx-auto p-8">
          <h1 className="text-4xl font-light text-gray-900 mb-6">1.2 Document Upload</h1>
          <p className="text-gray-600 mb-8">
            Upload required documents for your financial institution registration.
          </p>
          ...
          <div className="mt-8">
            <div className="w-3 h-3 rounded-full border-2 border-gray-500 mx-auto mb-2"></div>
            <p className="text-sm text-gray-500">Pending Step</p>
          </div>
        </div>
      </div>
    </div>
